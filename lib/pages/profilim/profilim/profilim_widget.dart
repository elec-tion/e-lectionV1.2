  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> profilimUsersRowList = snapshot.data!;
        final profilimUsersRow =
            profilimUsersRowList.isNotEmpty ? profilimUsersRowList.first : null;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'xxejesxf' /* To change your profile photo, ... */,
                                          ),
