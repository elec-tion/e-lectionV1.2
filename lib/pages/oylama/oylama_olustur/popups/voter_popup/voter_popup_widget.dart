...
class VoterPopupWidget extends StatefulWidget {
  const VoterPopupWidget({super.key});

  @override
  State<VoterPopupWidget> createState() => _VoterPopupWidgetState();
}

class _VoterPopupWidgetState extends State<VoterPopupWidget> {
  late VoterPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VoterPopupModel());
  }
