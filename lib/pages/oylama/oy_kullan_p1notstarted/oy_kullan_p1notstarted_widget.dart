...
import 'oy_kullan_p1notstarted_model.dart';
...
class OyKullanP1notstartedWidget extends StatefulWidget {
  ...
  State<OyKullanP1notstartedWidget> createState() =>
      _OyKullanP1notstartedWidgetState();
}

class _OyKullanP1notstartedWidgetState
    extends State<OyKullanP1notstartedWidget> {
  late OyKullanP1notstartedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OyKullanP1notstartedModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> oyKullanP1notstartedUsersRowList = snapshot.data!;
        final oyKullanP1notstartedUsersRow =
            oyKullanP1notstartedUsersRowList.isNotEmpty
                ? oyKullanP1notstartedUsersRowList.first
                : null;
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: oyKullanP1notstartedUsersRow!.photoUrl,
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'ib9lcc1k' /* Voting Has Not Started Yet. */,
                                      ),
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'uj0l5ovf' /* Until voting will start: */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
