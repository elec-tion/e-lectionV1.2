...
import 'oy_kullan_o_l_d_model.dart';
export 'oy_kullan_o_l_d_model.dart';

class OyKullanOLDWidget extends StatefulWidget {
  const OyKullanOLDWidget({super.key});

  @override
  State<OyKullanOLDWidget> createState() => _OyKullanOLDWidgetState();
}

class _OyKullanOLDWidgetState extends State<OyKullanOLDWidget> {
  late OyKullanOLDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OyKullanOLDModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> oyKullanOLDUsersRowList = snapshot.data!;
        final oyKullanOLDUsersRow = oyKullanOLDUsersRowList.isNotEmpty
            ? oyKullanOLDUsersRowList.first
            : null;
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: oyKullanOLDUsersRow!.photoUrl,
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
