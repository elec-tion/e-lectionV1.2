...
class OyKullanP5PusulaWidget extends StatefulWidget {
  const OyKullanP5PusulaWidget({super.key});
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: CachedNetworkImage(
                      ...
                      imageUrl: oyKullanP5PusulaUsersRow!.photoUrl,
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
...
.................... */
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '4vk0vjpg' /* The Candidate You Vote For */,
                                                  ),
                  ...
                  Flexible(
                    child: Container(
                      ...
                      height: 243.0,
                      decoration: BoxDecoration(
                        color: FlutterFlowTheme.of(context).graSet21,
                      ),
                      child: Padding(
                        padding:
                                  ...
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          if (_model.givevotecheckboxValue!) {
                                            context
                                                .pushNamed('OyKullanP6Final');
                                          } else {
                                      ...
                                      children: [
                                        Theme(
                                          ...
                                          child: Checkbox(
                                            ...
                                            activeColor: const Color(0xFFE1E1E1),
                                            checkColor: const Color(0xFF242424),
                                          ),
                                        ),
                                      ],
                                    ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'uwubt0r1' /* I confirm this information and... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
