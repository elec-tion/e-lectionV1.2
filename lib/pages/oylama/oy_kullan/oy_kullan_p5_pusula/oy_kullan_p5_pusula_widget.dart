                                                                  ...
                                                                  if (FFLocalizations.of(
                                                                    ...
                                                                    await showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              const Text('Please read and accept to continue.'),
                                                                          content:
                                                                              const Text('You need to approve the conditions.'),
                                                                          actions: [
                                                                            TextButton(
                                                                    ...
                                                                    await showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              const Text('Okuyup Onaylamanız Gerekiyor!'),
                                                                          content:
                                                                              const Text('Devam etmek için koşulları onaylamanız gerekiyor.'),
                                                                          actions: [
                                                                            TextButton(
                                                                              onPressed: () => Navigator.pop(alertDialogContext),
