  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ElectionsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ElectionsRow> oyKullanP1notstartedElectionsRowList =
            snapshot.data!;
        final oyKullanP1notstartedElectionsRow =
            oyKullanP1notstartedElectionsRowList.isNotEmpty
                ? oyKullanP1notstartedElectionsRowList.first
                : null;
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              oyKullanP1notstartedElectionsRow
                                                  ?.name,
                                              'electionName',
                                            ),
