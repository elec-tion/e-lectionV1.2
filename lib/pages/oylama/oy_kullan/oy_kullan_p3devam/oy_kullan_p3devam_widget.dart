  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> oyKullanP3devamUsersRowList = snapshot.data!;
        final oyKullanP3devamUsersRow = oyKullanP3devamUsersRowList.isNotEmpty
            ? oyKullanP3devamUsersRowList.first
            : null;
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: oyKullanP3devamUsersRow!.photoUrl,
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
