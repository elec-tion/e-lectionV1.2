...
class OyKullanP1resWidget extends StatefulWidget {
  const OyKullanP1resWidget({
    super.key,
    this.givevote,
  });
  ...
  @override
  State<OyKullanP1resWidget> createState() => _OyKullanP1resWidgetState();
}

class _OyKullanP1resWidgetState extends State<OyKullanP1resWidget>
    with TickerProviderStateMixin {
  late OyKullanP1resModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OyKullanP1resModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().forLoop = 0;
      FFAppState().update(() {});
      FFAppState().statisticCandidate = [];
      FFAppState().update(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> oyKullanP1resUsersRowList = snapshot.data!;
        final oyKullanP1resUsersRow = oyKullanP1resUsersRowList.isNotEmpty
            ? oyKullanP1resUsersRowList.first
            : null;
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '8ukwg80e' /* Voting Results Has Been Announ... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'i9i2k1ko' /* Voting was finished at: */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
