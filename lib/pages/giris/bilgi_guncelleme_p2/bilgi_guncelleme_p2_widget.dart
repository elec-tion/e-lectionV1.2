                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if ((FFAppState().countryID != '') &&
                              ...
                              setState(() {
                                FFAppState()
                                    .addToUserDistrictIDs(FFAppState().cityID);
                              });
                              setState(() {
                                FFAppState().addToUserDistrictIDs(
                                    FFAppState().districtID);
                              ...
                              await UsersTable().update(
                                data: {
                                  'districts': FFAppState().userDistrictIDs,
                                },
                              ...
                              _model.countryVarMi =
                                  await DistrictGroup.getDistrictCall.call(
                                id: FFAppState().countryID,
                              );
                              if (!(_model.countryVarMi?.succeeded ?? true)) {
                              ...
                              if (!(_model.cityVarMi?.succeeded ?? true)) {
                                await DistrictGroup.addDistrictCall.call(
                                  id: FFAppState().cityID,
                              ...
                              if (!(_model.districtVarMi?.succeeded ?? true)) {
                                await DistrictGroup.addDistrictCall.call(
                                  id: FFAppState().districtID,
