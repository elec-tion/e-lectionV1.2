  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> bilgiGuncellemeP1UsersRowList = snapshot.data!;
        final bilgiGuncellemeP1UsersRow =
            bilgiGuncellemeP1UsersRowList.isNotEmpty
                ? bilgiGuncellemeP1UsersRowList.first
                : null;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .guncelleTelefonTextController,
                                        focusNode:
                                            _model.guncelleTelefonFocusNode,
                                        autofocus: false,
                                        textCapitalization:
                                    ...
                                    if (_model.mailTest != null &&
                                      ...
                                      if (_model.telTest != null &&
                                        ...
                                        await CommitteeMemberGroup
                                          ...
                                          name:
                                              '${_model.guncelleIsimTextController.text} ${_model.guncelleSoyadTextController.text}',
                                          wallet: bilgiGuncellemeP1UsersRow
